...
הערה עיצובית:
  הנוסחה משקפת את עקרונות העיצוב של המערכת — לא "נכונה"
  במובן אמפירי. המשקלות והסף יכוילו לפי נתוני שיבוצים אמיתיים
  דרך ה-Feedback Loop. המבנה הלוגי (כפל, שורש שלישי, סף כפול)
  הוא בחירת עיצוב מנומקת, לא עובדה מוכחת.
"""
